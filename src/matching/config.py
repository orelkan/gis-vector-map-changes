...
Every value here is justified in docs/matching-behavior.md against
...
# see docs/matching-behavior.md section 2.
METRIC_CRS = "EPSG:2039"

# Stage 5: an ID- or geometry-matched pair with iou >= this is `unchanged`
# geometry-wise; below it, `modified_geometry`. See docs/matching-behavior.md
...
# silently matched. Deliberately strict -- see docs/matching-behavior.md
...
# 129 yearly). See docs/matching-behavior.md section 1, finding 5.
...
# docs/matching-behavior.md section 6g.
